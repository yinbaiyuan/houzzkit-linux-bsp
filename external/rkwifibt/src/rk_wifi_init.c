...
int wifibt_load_driver(void)
{
	...
	//rpdzkj add for skip insmod wifi ko when driver buildin
	if (1 == wifi_dirver_is_loaded) {
         printf("WIFI driver has been loaded, skip insmod\n");
         printf("Now will init bt...\n");
        }
	else{
