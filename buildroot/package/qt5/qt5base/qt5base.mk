...
ifeq ($(BR2_PACKAGE_QT5BASE_XCB),y)
define QT5BASE_INSTALL_TARGET_ENV_XCB
	$(INSTALL) -D -m 0644 $(QT5BASE_PKGDIR)/qt_xcb.sh \
		$(TARGET_DIR)/etc/profile.d/qt_xcb.sh
endef
QT5BASE_POST_INSTALL_TARGET_HOOKS += QT5BASE_INSTALL_TARGET_ENV_XCB
endif
