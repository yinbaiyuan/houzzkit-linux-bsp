...
static void rtl8821ce_xmit_tasklet(unsigned long priv)
{
	_irqL irqL;
...
s32 rtl8821ce_init_xmit_priv(_adapter *padapter)
{
	...
	tasklet_init(&pxmitpriv->xmit_tasklet, rtl8821ce_xmit_tasklet,
...
#ifdef CONFIG_RTW_MGMT_QUEUE
s32 rtl8821ce_hal_mgmt_xmitframe_enqueue(_adapter *padapter,
					struct xmit_frame *pxmitframe)
{
	struct xmit_priv *pxmitpriv = &padapter->xmitpriv;
	s32 err;
