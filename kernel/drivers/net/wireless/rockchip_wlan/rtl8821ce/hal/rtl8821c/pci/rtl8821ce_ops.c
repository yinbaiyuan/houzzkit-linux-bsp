...
static void rtl8821ce_unmap_beacon_icf(PADAPTER Adapter)
{
...
void rtl8821ce_set_hal_ops(PADAPTER padapter)
{
	...
	*/
	...
	ops->hal_mgmt_xmitframe_enqueue = rtl8821ce_hal_mgmt_xmitframe_enqueue;
#endif
	...
	ops->unmap_beacon_icf = rtl8821ce_unmap_beacon_icf;
}
